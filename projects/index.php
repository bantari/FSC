...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110621_0244.jpg"); ?>
    <?php echo get_thumb("Elisif_20110621_0255.jpg"); ?>
  </div>
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110621_0260.jpg"); ?>
    <?php echo get_thumb("Elisif_20110613_9237.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110615_9238.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110615_9242.jpg"); ?>
    <?php echo get_thumb("Elisif_20110615_9244.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110615_9245.jpg"); ?>
    <?php echo get_thumb("Elisif_20110615_9257.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110615_9259.jpg"); ?>
    <?php echo get_thumb("Elisif_20110615_9241.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110615_9260.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<div class="columns">
  <div class="column first" style="width:120px;">
    <?php echo get_thumb("Elisif_20110615_9262.jpg"); ?>
    <?php echo get_thumb("Elisif_20110615_9263.jpg"); ?>
  </div>
  <div class="column last" style="width:500px;">
...
<?php
  echo clear();
  include "__includes/init_gallery.php";
?>
